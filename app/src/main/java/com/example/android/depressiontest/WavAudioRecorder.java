...
import static com.projects.alshell.vokaturi.Vokaturi.logE;
    ...
    public class WavAudioRecorder
    {
        ...
        public static WavAudioRecorder getInstance(Boolean recordingCompressed)
        {
            logD("Instantiating the WavAudioRecorder class");
        ...
        private AudioRecord.OnRecordPositionUpdateListener updateListener = new AudioRecord.OnRecordPositionUpdateListener()
        {
            public void onPeriodicNotification(AudioRecord recorder)
            {
                ...
                {
                    logE( "Error occured in updateListener, recording is aborted");
                    //stop();
                }
            }
         ...
         *
         */
        public WavAudioRecorder(boolean uncompressed, int audioSource, int sampleRate, int channelConfig, int audioFormat)
        {
            try
            {
                ...
                { // RECORDING_UNCOMPRESSED
                    ...
                    { // Check to make sure buffer size is not smaller than the smallest allowed one
                        ...
                        logD("Increasing buffer size to " + Integer.toString(bufferSize));
                    }
            ...
            try
            {
                if (state == State.INITIALIZING)
                {
                    if (rUncompressed)
                    {
                        ...
                        {
                            logE("prepare() method called on uninitialized recorder");
                            state = State.ERROR;
                        }
                    }
                    else
                ...
                {
                    logE("prepare() method called on illegal state");
                    release();
                    state = State.ERROR;
                }
            }
        ...
        public void start()
        {
            ...
            {
                logE("start() called on illegal state");
                state = State.ERROR;
            }
        }
        ...
        public void stop()
        {
            ...
            {
                logE("stop() called on illegal state");
                state = State.ERROR;
            }
        }
